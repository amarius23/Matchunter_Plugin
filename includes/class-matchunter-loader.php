...
class Matchunter_Loader {
	...
	/**
	 * Add a new shotrcode to the collection to be registered with WordPress.
	 *
	 * @since 1.0.0
	 ...
	 * @param integer $accepted_args Optional. The number of arguments that should be passed to the $callback. Default is 2
	 */
